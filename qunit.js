...
(function(window) {
    ...
    var QUnit = {
        ...
        init: function() {
            ...
            addEvent(banner, "dblclick", function() {
                if (window.location) {
        ...
        test: function(testName, expected, callback, async) {
            ...
            if (config.currentModule) {
                name = config.currentModule.toUpperCase() + ": should " + name;
            }
    ...
    QUnit.asyncShould = QUnit.asyncTest;
    QUnit.aShould = QUnit.asyncTest;
    ...
    function push(result, actual, expected, message) {
        ...
        var expectedParse = QUnit.jsDump.parse(expected);
        var actualParse = QUnit.jsDump.parse(actual);
        QUnit.ok(result, result ? message + ": " + expected : message + ", expected: " + expectedParse + " result: " + actualParse);
    }
